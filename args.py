...
def get_args():
    ...
    parser.add_argument('--local_data_path', type=str, default='./ddata', help='local path of data')
    ...
    parser.add_argument('--fasttext_epochs', type=int, default=100)
    ...
    parser.add_argument('--kernel_size', type=list, default=2)
